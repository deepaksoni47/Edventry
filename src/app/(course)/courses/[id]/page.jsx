...
import { Star, Users, Clock, Calendar, BookOpen, Play, CheckCircle, ArrowRight, Share2, Heart, MessageCircle, Award, Target, Globe, Zap } from 'lucide-react';
  ...
  const course = {
    ...
    curriculum: [
      ...
      },
      {
        ...
        title: "CSS Styling",
        lessons: [
          { id: 11, title: "Introduction to CSS", duration: "30 min", type: "video", free: false },
          { id: 12, title: "CSS Selectors and Properties", duration: "45 min", type: "video", free: false },
          { id: 13, title: "Box Model and Layout", duration: "40 min", type: "video", free: false },
          { id: 14, title: "Flexbox Layout", duration: "55 min", type: "video", free: false },
          { id: 15, title: "CSS Grid", duration: "50 min", type: "video", free: false }
        ]
      }
    ],
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: "2025-01-10",
        comment: "Amazing course! Sarah explains everything so clearly. I went from knowing nothing about web development to building my own websites. Highly recommended!",
        helpful: 12
      },
      {
        id: 2,
        ...
        rating: 5,
        date: "2025-01-08",
        comment: "The projects are really practical and helped me understand the concepts better. The instructor is very responsive to questions.",
        helpful: 8
      },
      {
        id: 3,
        ...
        rating: 4,
        date: "2025-01-05",
        comment: "Great course structure and content. Some sections could be a bit more detailed, but overall excellent learning experience.",
        helpful: 5
      }
    ]
  };
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 mb-8">
            ...
            <div className="p-6">
                      ...
                      <div key={week.week} className="border border-gray-200 rounded-lg">
                        ...
                        <div className="p-4">
                          {week.lessons.map((lesson) => (
                            <LessonItem key={lesson.id} lesson={lesson} weekNumber={week.week} />
                          ))}
                        </div>
                      </div>
                    ))}
              ...
              {activeTab === 'instructor' && (
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 mb-6">Your Instructor</h3>
                    ...
                    <div className="flex-1">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                        <div className="text-center">
                          <div className="text-lg font-semibold text-gray-900">{course.instructor.students.toLocaleString()}</div>
                          <div className="text-sm text-gray-600">Students</div>
                        </div>
                        <div className="text-center">
                          <div className="text-lg font-semibold text-gray-900">{course.instructor.courses}</div>
                          <div className="text-sm text-gray-600">Courses</div>
                        </div>
                        <div className="text-center">
                          <div className="text-lg font-semibold text-gray-900">{course.instructor.rating}</div>
                          <div className="text-sm text-gray-600">Rating</div>
                        </div>
                        <div className="text-center">
                          <div className="text-lg font-semibold text-gray-900">{course.instructor.experience}</div>
                ...
                <div>
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-gray-600">({course.totalReviews} reviews)</span>
                    </div>
                  </div>
              ...
              <div className="space-y-4 text-sm">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-gray-700">{course.students.toLocaleString()} students enrolled</span>
                  </div>
                  <div className="flex items-center space-x-3">
