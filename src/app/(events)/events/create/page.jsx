...
import { ArrowLeft, ArrowRight, Upload, Plus, X, Calendar, Users, Clock, DollarSign, Target, FileText, Video, CheckCircle } from 'lucide-react';
...
const CreateEventPage = () => {
  ...
  const renderStep1 = () => (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mb-6">Let's start with the basic details of your event.</p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            placeholder="A brief description of what participants will learn"
            className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          />
        </div>
  ...
  const renderStep2 = () => (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Event Details & Pricing</h3>
        <p className="text-gray-600 mb-6">Set your event schedule, capacity, and pricing.</p>
      </div>
  ...
  const renderStep3 = () => (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Learning Outcomes & Requirements</h3>
        <p className="text-gray-600 mb-6">Define what participants will learn and what they need to know.</p>
      </div>
            ...
            {formData.learningOutcomes.map((outcome, index) => (
              <div key={index} className="flex items-center space-x-2">
                <input
                  ...
                  placeholder="e.g., Master advanced React patterns and best practices"
            ...
            {formData.requirements.map((requirement, index) => (
              <div key={index} className="flex items-center space-x-2">
                <input
                  ...
                  placeholder="e.g., Basic knowledge of JavaScript and React fundamentals"
                  className="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
                <button
                  type="button"
          ...
          <div>
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-gray-900">{formData.duration || 'Not set'}</p>
              </div>
              <div>
                <span className="text-sm font-medium text-gray-600">Capacity:</span>
                <p className="text-gray-900">{formData.capacity || 'Not set'}</p>
              </div>
              <div>
